...
{
    public partial class mansi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardType = table.Column<string>(type: "nvarchar(30)", nullable: true),
                    RemainingBalance = table.Column<decimal>(type: "decimal(38,4)", nullable: false),
                    amountSpent = table.Column<decimal>(type: "decimal(38,4)", nullable: false),
                    cardNumber = table.Column<string>(type: "nvarchar(18)", nullable: true),
                    cardStatus = table.Column<string>(type: "nvarchar(10)", nullable: true),
                    Validity = table.Column<string>(type: "nvarchar(10)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    joiningFees = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
